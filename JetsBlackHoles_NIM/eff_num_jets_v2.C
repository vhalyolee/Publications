...
//=========  (Sat Sep 21 22:44:46 2013) by ROOT version5.28/00h
   ...
   TProfile *k20c = new TProfile("k20c","Efficiency vs. number of displaced jets, 10 tracks/jet",6,-0.5,5.5,"");
   ...
   pt->SetBorderSize(0);
   pt->SetFillStyle(0);
   TText *text = pt->AddText("Efficiency vs. number of displaced jets, 10 tracks/jet");
   pt->Draw();
   c1->Modified();
   c1->cd();
   c1->SetSelected(c1);
