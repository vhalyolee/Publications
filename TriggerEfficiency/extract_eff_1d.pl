...
my $mh = 125;
my $mx = 20;
my @ct_vals = (10, 20, 40, 50, 100, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600);
...
my $effvals = "float eff_all[nctau][ntrigs] = {\n";
my $efferrs = "float efferr_all[nctau][ntrigs] = {\n";
...
print "\n// efficiency vs. ctau, mH = $mh, mX = $mx GeV/c^2\n";
print $effvals, "};\n";
