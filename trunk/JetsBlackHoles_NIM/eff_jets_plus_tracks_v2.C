...
//=========  (Sat Sep 21 22:40:37 2013) by ROOT version5.28/00h
   ...
   TProfile *k20c = new TProfile("k20c","Efficiency vs. number of displaced jets, 3000 tracks/event",6,-0.5,5.5,"");
   ...
   pt->SetBorderSize(0);
   pt->SetFillStyle(0);
   TText *text = pt->AddText("Efficiency vs. number of displaced jets, 3000 tracks/event");
   pt->Draw();
   c1->Modified();
   c1->cd();
   c1->SetSelected(c1);
   ...
   c1->Print("eff_jets_plus_tracks.pdf");
}
