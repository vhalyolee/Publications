...
The quest for rare new physics phenomena at the LHC leads us to evaluate a Graphics Processing Unit (GPU) enhancement of
...
\begin{figure}[!Hhtb]
  \begin{center}
    \subfigure[]{\includegraphics[width=0.5\textwidth]{figs/CMSTrigger.pdf} \label{fig:hltarc}}
    \subfigure[]{\includegraphics[width=0.4\textwidth]{figs/Tesla_M1060_1u_Super_Micro_Front_Elevated_no_cover_large.pdf} \label{fig:integratedsys}}
...
by a finite number of parameters.  For example, circles of unknown location and radius can be identified in a three-dimensional parameter 
